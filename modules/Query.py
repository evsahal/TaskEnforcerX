...
boss_monster.monster_category,boss_monster.system,boss_monster.enable_map_scan,boss_monster.monster_logic_id, 
monster_level_info.level,monster_level_info.name, monster_level_info.size, monster_image.preview_image, 
monster_image.img_540p, monster_image.img_1080p, boss_monster.monster_image_id from 
boss_monster, monster_level_info,monster_image where boss_monster.monster_image_id = monster_image.id and 
...
add_monster_image_query = "insert into monster_image(preview_image,img_540p,img_1080p) values(:p_img,:540p,:1080p)"
