...
from PyQt5.QtWidgets import QMainWindow, QVBoxLayout, QListWidget, QListWidgetItem, QWidget, QHBoxLayout, QPushButton, \
    QFrame, QFileDialog, QLineEdit, QComboBox, QCheckBox, QDoubleSpinBox, QSpinBox
...
class UploadNormalMonsterItem(QWidget, Ui_normal_monster_item):
    def __init__(self, properties, parent=None):
        ...
        try:
            ...
            self.img_threshold.setObjectName("img_threshold_" + str(properties['id']))
            self.click_pos_x.setObjectName("click_pos_x" + str(properties['id']))
            self.click_pos_y.setObjectName("click_pos_y" + str(properties['id']))
...
class UploadBossMonsterItem(QWidget, Ui_boss_monster_item):
    def __init__(self, properties, parent=None):
        ...
        try:
            ...
            self.img_540p.setObjectName("img_540p_" + str(properties['id']))
            self.img_threshold.setObjectName("img_threshold_" + str(properties['id']))
            self.click_pos_x.setObjectName("click_pos_x_" + str(properties['id']))
            self.click_pos_y.setObjectName("click_pos_y_" + str(properties['id']))
    ...
    def upload_items(self):
        ...
        if self.upload_type == "monster_upload":
            ...
            for i in range(self.upload_items_fc.count()):
                ...
                data['img_threshold'] = widget.findChild(QDoubleSpinBox, "img_threshold_" + str(index)).value()
                click_pos = {'x': widget.findChild(QSpinBox, "click_pos_x" + str(index)).value(),
                             'y': widget.findChild(QSpinBox, "click_pos_y" + str(index)).value()}
                data['click_pos'] = json.dumps(click_pos)
                items.append(data)
                # print(data)
            flag = True
            for index, item in enumerate(items):
                ...
                tmp_flag = False if item['directory_path'] == '' or item['monster_name'] == '' or item[
                    'preview_image'] == '' or item['img_540p'] == '' else True
                if not tmp_flag:
                    flag = tmp_flag
                ...
                tmp_list = 'preview_image', 'img_540p'
                for key in tmp_list:
                    if item[key] == '':
            ...
            for index, item in enumerate(items):
                ...
                monster_image = {"p_img": item['preview_image'], "540p": item['img_540p'],
                                 "threshold": item['img_threshold'], "click_pos": item['click_pos']}
            ...
            for index, item in enumerate(items):
                ...
                tmp_flag = False if item['directory_path'] == '' or item['scoutables_name'] == '' or item[
                    'type'] == '' or item['preview_image'] == '' or item['img_540p'] == '' else True
                if not tmp_flag:
                    flag = tmp_flag
                    self.upload_console.appendPlainText(f"\u2022 Some fields are empty in item {index + 1}")
                # Validate name is already not in use
            ...
            for index, item in enumerate(items):
                ...
                self.upload_console.appendPlainText(tmp_log)
                self.upload_console.appendPlainText("-" * (len(tmp_log) + 3))
                scout_image = {"p_img": item['preview_image'], "540p": item['img_540p'],
                               "threshold": item['img_threshold'], "click_pos": item['click_pos']}
            ...
            for i in range(self.upload_items_fc.count()):
                ...
                data['img_540p'] = widget.findChild(QLineEdit, "img_540p_" + str(index)).text()
                data['img_threshold'] = widget.findChild(QDoubleSpinBox, "img_threshold_" + str(index)).value()
                click_pos = {'x': widget.findChild(QSpinBox, "click_pos_x_" + str(index)).value(),
                             'y': widget.findChild(QSpinBox, "click_pos_y_" + str(index)).value()}
                data['click_pos'] = json.dumps(click_pos)
            ...
            for index, item in enumerate(items):
                ...
                self.upload_console.appendPlainText(tmp_log)
                self.upload_console.appendPlainText("-" * (len(tmp_log) + 3))
                boss_image = {"p_img": item['preview_image'], "540p": item['img_540p'],
                              "threshold": item['img_threshold'], "click_pos": item['click_pos']}
